...
//Проверка:
console.log(copyStudents === students) // false - что должно быть в консоли?
console.log(copyStudents[0] === students[0]) // true - что должно быть в консоли?
console.log(copyStudents[0].name === students[0].name) // true - что должно быть в консоли?
console.log(copyStudents[0]['age'] === students[0]['age']) // true что должно быть в консоли?
...
console.log(deepCopyStudents[0] === students[0]) // false - что должно быть в консоли?
console.log(deepCopyStudents[0].name === students[0].name) // true - что должно быть в консоли?
console.log(deepCopyStudents[0]['age'] === students[0]['age']) // true - что должно быть в консоли?

// NB!!! Далее все преобразования выполняем не модифицируя исходный массив students
// Вывод результатов - в консоль

//5. Отсортируйте копию массива deepCopyStudents по алфавиту (sort)
let sortedByName = deepCopyStudents.map(el => ({...el}))
sortedByName.sort((a, b) => a.name > b.name ? 1 : -1);
console.log(sortedByName);

//5a. Отсортируйте deepCopyStudents по успеваемости(лучший идёт первым)(sort)
let sortedByScores = deepCopyStudents.map(el => ({...el}))
sortedByScores.sort((a,b)=> b.scores - a.scores)
...
let bestStudent = newDeepCopyStudents.reduce((acc, cur) => acc.scores > cur.scores ? acc : cur)
console.log(bestStudent)

//13. Найдите сумму баллов всех студентов (reduce)
let scoresSum = newDeepCopyStudents.reduce((acc, cur) => acc + cur.scores, 0);
